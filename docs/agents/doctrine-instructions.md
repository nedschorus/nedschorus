...
These are open-ended subjects, so one series of work means one item carried to one of those three endings — not the item's whole subject closed, and not this seat's work emptied. Whatever you did not finish goes in the handoff by name, so the next session does not rediscover it. Then stop.
