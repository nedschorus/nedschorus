...
The evidence is `git show db917b5:md-review-records/2026-08-12-attack-split-experiment/scorecard.md`, also in PR #53. Read it before the walk, because the user's first question will be what its numbers mean, and this file deliberately does not restate them — a summary you cannot defend is worse than none.
