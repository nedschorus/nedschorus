...
Provenance: original directive in session 3b576242 (machine-local transcript), committed echo in the legacy worktree at `tasks/sessions/new-vp-walk-ledger-standing-items-2026-07-27.md` (item 3); instruction text drafted by the user in session 9a618380.
