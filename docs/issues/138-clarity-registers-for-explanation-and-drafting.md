# Clarity registers for explanation and drafting — GHI-MD for issue [Clarity registers: explanations and drafted instruction text land without the user's repeated corrections](https://github.com/nedschorus/nedschorus/issues/138)
...
2. The project output style: exact style text, home, activation, and its reach
   (chat register, fleet-wide via checked-in settings). Cites issue [Runtime-behavior research bundle: instruction compression + deliberate scrub, instruction precedence, output styles, context clearing, names reviewer, memory maintenance](https://github.com/nedschorus/nedschorus/issues/29) item 4
   ...
   *processed 2026-08-22 → REVISED then accepted: the user rewrote three rules —
   ...
   Carried by PR [Zero-Context Explanation output style, activated fleet-wide](https://github.com/nedschorus/nedschorus/pull/156) as
...
3. walk-me-through amendment: every item written for a reader with no conversation
   history (before/after: the diff of PR [walk-me-through: items written for a reader with no history; the fresh reader's restatement revises the draft](https://github.com/nedschorus/nedschorus/pull/155)).
   *processed 2026-08-22 → accepted with the walk-scope clause (pre-walk history
   ...
   by PR [walk-me-through: items written for a reader with no history; the fresh reader's restatement revises the draft](https://github.com/nedschorus/nedschorus/pull/155). Actor: the agent presenting a walk.*
4. walk-me-through amendment: adopt the fresh reader's restatement where it
   is clearer than the drafted text (before/after: the diff of PR [walk-me-through: items written for a reader with no history; the fresh reader's restatement revises the draft](https://github.com/nedschorus/nedschorus/pull/155)).
   *processed 2026-08-22 → accepted as revise-toward, on the reader's own
   ...
   PR [walk-me-through: items written for a reader with no history; the fresh reader's restatement revises the draft](https://github.com/nedschorus/nedschorus/pull/155). Actor: the agent presenting a walk, before it shows
   an item that proposes instruction text.*
5. CLAUDE.md drafting bullet: exact text, and when it lands (now, or pointing at
   md-write once built).
   *processed 2026-08-22 → accepted for CLAUDE.md and landed as the drafting bullet in `CLAUDE.md`, carried by PR [Instruction homes: the CLAUDE.md drafting bullet, and AGENTS.md becomes a pointer](https://github.com/nedschorus/nedschorus/pull/157). The
...
6. Routing: the drafting register into md-write's commissioned build (founding plan
   ...
   *processed 2026-08-22 → REVISED by the user, reversing the presented routing:
   ...
   collision. Build issue filed: issue [Build draft-md: the drafting-stage skill run before md-review (user-ruled 2026-08-22)](https://github.com/nedschorus/nedschorus/issues/142), carrying the scope boundary and
   the fresh-reader-rule migration question; timing his — end of this walk
   or soon after. Issue [Clarity registers: explanations and drafted instruction text land without the user's repeated corrections](https://github.com/nedschorus/nedschorus/issues/138)'s body edited to match (its draft-md-rejected line
...
7. The explain skill: hold with a reopen condition, or build now.
   *processed 2026-08-22 → accepted: HELD. The output style covers the one-shot
   ...
   `.claude/settings.json` (carried by PR [Zero-Context Explanation output style, activated fleet-wide](https://github.com/nedschorus/nedschorus/pull/156)),
   `.claude/skills/walk-me-through/SKILL.md`, `CLAUDE.md`, `AGENTS.md`, issues
   issue [Clarity registers: explanations and drafted instruction text land without the user's repeated corrections](https://github.com/nedschorus/nedschorus/issues/138) and issue [Build draft-md: the drafting-stage skill run before md-review (user-ruled 2026-08-22)](https://github.com/nedschorus/nedschorus/issues/142), the latter's
   GHI-MD `docs/issues/142-draft-md-skill-design-notes.md` (carried by
   PR [Pair document: draft-md design notes (nedschorus#142)](https://github.com/nedschorus/nedschorus/pull/160)), and this anchor.*
