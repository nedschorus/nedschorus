...
What agents actually write is short ids, 7 to 8 hex characters. Of eleven hand-written ids sampled across `docs/`, `nc-queue/` and the uncommitted handoffs, nine resolve to real commits in this repository. Two do not:
