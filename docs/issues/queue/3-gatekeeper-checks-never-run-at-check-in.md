...
The program says so itself. `nc-systems/main-gatekeeper/main-gatekeeper.py:823-825`, inside `integrate_and_push`, at the exact place the spec designates:
