...
Your work comes from your launch prompt first; when it directs nothing further, work the architecture and working plan (docs/wiki/queue/nedschorus-ai-native-software-development-objective.md) and the open issues, and when neither decides your next act, ask the user.
