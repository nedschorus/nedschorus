...
3. Do what it reports. If a supervisor is watching, stop working and wait — it takes over within seconds. If none is, do not stop: keep working, and tell the user that the handoff is written but nothing is watching for it.
