...
7. What to do, step 4 — write for a fresh reader
...
4. Write for a fresh reader. Before submitting, check the three tests: the subject is identifiable from the issue alone; the why is stated; the next action is executable by a reader who was not in this conversation.
