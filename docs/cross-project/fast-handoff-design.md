...
- Pre-seed (the unpinned-session path since PR #141) and the seat-pin variable both ride undocumented harness state; detection is the ignition count-check, the queues are the backstop, the `--canary` cases are the diagnosis (accepted risk, user-ruled 2026-08-12).
