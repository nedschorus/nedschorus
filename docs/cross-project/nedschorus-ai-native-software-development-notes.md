...
| [Agent seat/worktree model](https://github.com/nedschorus/nedschorus/blob/main/docs/nedschorus-wiki/agent-seat-model.md) | **Built** | Keep worktree isolation and disposable workers. Distinguish sustained human-facing seats from task-scoped node executions. |
