...
| Built/in-process/planned map, issue [built-in-process-planned documents: design docs convert to a pointer map of built / in process / planned, with a skill that verifies and updates them](https://github.com/nedschorus/nedschorus/issues/219) | **Planned** | Useful for system ownership and preventing plans from masquerading as code. It is documentation support, not the runtime workflow engine. |
