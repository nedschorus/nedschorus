...
Queued for the boss's drain. Destination when drained: the `md-write` founding skill's text (step-1 build) or wiki doctrine — wherever NC's decision-record writing lands.
