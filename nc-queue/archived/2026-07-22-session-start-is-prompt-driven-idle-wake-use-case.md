...
walk-item: standing-items walk item 2 (user-ruled, with his mechanism correction folded)
...
User observation (2026-07-22, at the day-3 successor wake): "I had to type stuff to wake up this agent. That may be the design, that agents always start in an ideal state. If that is true we have yet another use for an idle-wake function."
...
- The user's typed prompt ("read handoff and continue") arrived at `00:30:48.975Z`, and only then did the first model turn start, with the hook context bundled into it.
