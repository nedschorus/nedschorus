...
The intake directory for boss-requested notes awaiting their initial walk (boss-ruled 2026-07-22; the rule of record is [nedschorus-ai-native-software-development.md](../docs/wiki/queue/nedschorus-ai-native-software-development-objective.md) § Project organization).
