...
- **engineering:documentation** — docs/README/runbook writing. processed 2026-07-30 → **DROP** (user-ruled) — subsumed by the imminent md-write founding build (step 1, skills-first): zero-context-reader discipline and artifact-lifecycle rules own this whole territory; genre checklists are generic filler, no extract.
